...
The coordinate frames of the earth is dived into two, namely EIC and earth fixed coordinate (EFC) frames. EFC is fixed to the earth and rotates with it. This frame is important with respect to where the satellite position is with regards to position's on earth, such as the ground station. It is also import for the modelling of the geomagnetic fields. 
